...
import { CapabilityRouter, FastpathError } from '@agentctl/core';
...
import { FastpathEvidenceSchema, handleFastpathEvidence, handleFastpathCapabilities } from './tools/evidence.js';
                ...
                tools: [
                    {
                        ...
                        description: 'Run fast typed semantic evaluation (choice/score/noul or presets like relevance, ship_gate, risk) over state without conversational overhead.',
                        inputSchema: {
                            type: 'object',
                            properties: {
                                state: {
                    ...
                    },
                    {
                        ...
                        description: 'Rank or filter files or items against a query without putting all full contents into the host LLM context.',
                        inputSchema: {
                            type: 'object',
                            properties: {
                    ...
                    },
                    {
                        ...
                        description: 'Perform one bounded browser operation (open, observe, act, check, choose, run_bounded). Returns compact observations with verified element tokens.',
                        inputSchema: {
                            type: 'object',
                            properties: {
                                mode: {
                    ...
                    },
                    {
                        ...
                        description: 'Retrieve expanded evidence, question breakdowns, and raw probability distributions for a previous traceId.',
                        inputSchema: {
                            type: 'object',
                            properties: {
                    ...
                    },
                    {
                        ...
                        description: 'Report active providers, limits, presets, and security settings without exposing secrets.',
                        inputSchema: {
                            type: 'object',
                            properties: {}
                        }
